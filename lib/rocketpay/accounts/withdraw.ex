defmodule Rocketpay.Accounts.Withdraw do
  ...
  # Dado um id e um value o valor é adicionado à conta do usuário
  # Dado
  ...
  defp update_balance(repo, account, value) do
    account |> sub_values(value) |> update_account(repo, account)
  end

  defp sub_values(%Account{balance: balance}, value) do
    value |> Decimal.cast() |> handle_cast(balance)
  end
